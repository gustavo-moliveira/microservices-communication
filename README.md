...
Este é um projeto desenvolvido para exercitar o conhecimento de microservices, mensageria e boas práticas do mercado. O projeto consiste em 3 serviços visando um sistema de vendas, onde tem um serviço de autenticação, de produto e vendas. Nele, pude aplicar diversas ferramentas muito utilizadas.
